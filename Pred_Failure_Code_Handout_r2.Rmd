...
```{r}
#Checking linearity, cant use tool.wear.min because it has values =< 0.They have to be positive

#"Type", "Process_temperature_K", "Rotational_speed_rpm", "Tool.wear_min", "Failure_Type"
#boxTidwell does not like any of the variables

boxTidwell(Failure_Type~ Process_temperature_K+Rotational_speed_rpm, max.iter = 2, other.x = ~Type,data=pred_failure)
